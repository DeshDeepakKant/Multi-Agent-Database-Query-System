...
def display_sidebar():
    ...
    st.sidebar.markdown("---")
    st.sidebar.caption("Implemented by: [Desh Deepak Kant]")

def display_example_questions():
    st.subheader("Or try one of these example questions:")
    cols_ex = st.columns(4)
    example_sets = {
        "Example 1": ["Who is the lead engineer?", "Status of 'API Integration Service' project?", "Projects for Desh Deepak Kant?"],
        "Example 2": ["Keywords for RAG paper by Desh Deepak Kant?", "Papers on 'Language Agents'?", "Who wrote 'Speculative RAG'?"],
        "Example 3": ["Tickets for MySQL issues?", "Support tickets by Desh Deepak Kant?", "Open tickets for Neo4j?"],
        "Example 4": ["Who collaborates with Desh Deepak Kant?", "papers about RAG from an author like Desh Deepak Kant", "Research field of Desh Deepak Kant?"],
