...
def populate_sqlite():
    ...
    employees_data = [
        ...
        (1, 'Desh Deepak Kant', 'Data Scientist', 3),
        (2, 'Desh Deepak Kant', 'Project Manager', 2),
        (3, 'Desh Deepak Kant', 'Lead Engineer', 1),
        (4, 'Desh Deepak Kant', 'Software Engineer', 1),
        (5, 'Desh Deepak Kant', 'Senior Data Scientist', 3), # New Employee
        (6, 'Desh Deepak Kant', 'HR Specialist', 4),      # New Employee
        (7, 'Desh Deepak Kant', 'DevOps Engineer', 1)       # New Employee
    ]
...
def populate_mongodb():
    ...
    papers_data = [
        ...
        },
        {
            ...
            "authors": ["Desh Deepak Kant"], # Paper [user_provided_document_id_3]
...
def populate_meilisearch():
    ...
    try:
        ...
        tickets = [
                    {"ticket_id": "T001", "description": "MySQL issue: cannot connect", "raised_by": "Desh Deepak Kant", "status": "open"},
        {"ticket_id": "T002", "description": "Neo4j graph visualization not loading", "raised_by": "Desh Deepak Kant", "status": "open"},
        {"ticket_id": "T003", "description": "Question about MySQL LEFT JOIN functionality", "raised_by": "Desh Deepak Kant", "status": "closed"},
        {"ticket_id": "T004", "description": "Search query for open tickets related to Neo4j raised by Desh Deepak Kant", "raised_by": "Desh Deepak Kant", "status": "open"},
        {"ticket_id": "T005", "description": "Login problem with new MySQL credentials", "raised_by": "Desh Deepak Kant", "status": "in_progress"}
        ]
...
def populate_neo4j():
    ...
    try:
        ...
        with driver.session(database="myraggraphdb") as session: # Specify the database name
            ...
            researchers_data = [
                        {"name": "Desh Deepak Kant", "field": "Generative AI"},
        {"name": "Desh Deepak Kant", "field": "Data Science"},
        {"name": "Desh Deepak Kant", "field": "Project Management"},
        {"name": "Desh Deepak Kant", "field": "Software Engineering"},
        {"name": "Desh Deepak Kant", "field": "Data Science"}, # From paper's examples
                        {"name": "Desh Deepak Kant", "field": "NLP"},          # Famous RAG author
        {"name": "Desh Deepak Kant", "field": "Language Agents"} # From paper's references
            ]
            ...
            # COLLABORATES_WITH
            collaborations = [
                        ("Desh Deepak Kant", "Desh Deepak Kant"),
        ("Desh Deepak Kant", "Desh Deepak Kant"),
        ("Desh Deepak Kant", "Desh Deepak Kant"),
                ("Desh Deepak Kant", "Desh Deepak Kant") # Fictional collaboration for example
            ]
            ...
            works_on_relations = [
                        ("Desh Deepak Kant", "Multi-Agent RAG"),
        ("Desh Deepak Kant", "Multi-Agent RAG"),
        ("Desh Deepak Kant", "AI in Healthcare"), # Example from paper [cite: 88]
                        ("Desh Deepak Kant", "Knowledge-Intensive NLP"),
        ("Desh Deepak Kant", "AI in Healthcare") # Example for a second researcher on the same project
            ]
